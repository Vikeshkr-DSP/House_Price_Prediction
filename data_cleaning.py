...
def impute_categorical_features(dataframe, fitted_impute_nan_cat, fitted_impute_none_cat):
    ...
    try:
        ...
        try:
            ...
            logger.logging.info('Missing values imputed successfully for MSZoning, Utilities, Functional, KitchenQual, Exterior2nd, Exterior1st, SaleType with most frequent category.')
        ...
        try:
            ...
            logger.logging.info('Missing values imputed successfully for fElectrical with most frequent category.')
